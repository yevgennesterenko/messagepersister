...
namespace MessageProcessorApplication
{
    ...
    class Program
    {        
        public static IDisposable GenerateRandomMessagesAtRandomIntervalsFromOneBus(IMessagerPersister persister)
        {
        ...
        public static void GenerateRandomMessagesAtRandomIntervalsFromSeveralBusesHighLoad(IMessagerPersister persister, out IDisposable subscription1, out IDisposable subscription2, out IDisposable subscription3)
        {
        ...
        private static void ProcessMessages(Message message, IMessagerPersister persister)
        {
